...
const Upload = () => {
  ...
  return (
    <div className='flex w-full h-full absolute left-0 top-[60px] mb-10 pt-10 lg:pt-20 bg-[#f8f8f8] justify-center'>
        <div className="bg-white rounded-lg  w-[90%] lg:w-[60%] flex gap-6 flex-wrap justify-between items-center p-14 pt-6">
            <div>
                <div>
                            ...
                            {videoAsset ? (
                                ...
                                <label className='cursor-pointer'>
                                    <div className='flex flex-col items-center justify-center h-full'>
                                        ...
                                        <p className="bg-accent text-center mt-10 rounded text-white text-md font-medium p-2 w-52 outline-none">Select File</p>
                                    </div>
                                    <input 
                                        type="file"
                                        name='upload-video'
