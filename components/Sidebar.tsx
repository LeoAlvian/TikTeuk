            ...
            <div className='px-2 py-4 hidden xl:block'>
              ...
              <div className="pr-4">
                <GoogleLogin 
                  ...
                  render={(renderProps) => (
                    <button
                      className='bg-white text-lg text-accent border-[1px] border-accent font-semibold px-6 py-3 rounded-md outline-none w-full mt-3 hover:text-white hover:bg-accent cursor-pointer'
